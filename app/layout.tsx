...
export const metadata: Metadata = {
  ...
  icons: {
    ...
    other: [
      { rel: 'android-chrome-192x192', url: '/android-chrome-192x192.png?v=2', sizes: '192x192' },
      { rel: 'android-chrome-512x512', url: '/android-chrome-512x512.png?v=2', sizes: '512x512' },
    ],
  },
